  ...
  render () {
    return (
      <div className='ReportPage'>
        ...
        <Filters allShifts={dummyShifts} toggleNameFilter={this.toggleNameFilter} toggleLocationFilter={this.toggleLocationFilter} toggleStatusFilter={this.toggleStatusFilter}/>
